# Проект автоматизации формирования заказов (заявок) поставщикам для пользователей сервиса ["Poster"](https://joinposter.com/)
...
3. Формирование страниц администрирования, формироваия запросов к БД проекта и БД "Poster" посредством [API сервиса](https://dev.joinposter.com/docs/v3/web/index) и ручного формирования заказов.
